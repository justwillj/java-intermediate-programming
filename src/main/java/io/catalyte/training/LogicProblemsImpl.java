...
public class LogicProblemsImpl implements LogicProblems {
  ...
  /**
   * This method will take a String and return the length of the last word inside the String. For
   * example "Test this String" will return a int of 6
   *
  ...
  /**
   * This method will find the number of different paths a person can take up a ladder if they can
   * only climb 1 or 2 steps at a time. For example if rungs = 3 then it will return a 3 since there
   * are 3 different ways to go up the ladder 1.(1,1,1) 2.(1,2) 3.(2,1)
   *
  ...
  /**
   * This method will look through a String array and group together words that share the same first
   * and last letter. It will then return inside another list for example. ["arrange", "act",
   * "assert", "ace"] will return a [["arrange", "ace"], ["act", "assert"]]
   *
